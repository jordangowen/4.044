            ...
            case "COLLISION":
                ...
                if (frameToShow == collisionAnimation.animation.length-1)  {
                    ...
                    // We haven't hit the max score yet, keep playing    
                        ...
                        targetOne.position = (0,displaySize);  // move the target to left
                        targetTwo.position = (30,displaySize);  // move the target to right
